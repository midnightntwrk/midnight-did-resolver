...
## Prototype Approach: JS/CLI Integration

### Location and Building the JS CLI
...
While this approach simplifies integration, it introduces overhead and complexity.
...
Each version of the `compact-runtime` is represented in Rust code (e.g., `compact_v0_8`), ensuring compatibility with the contract's serialization format.
