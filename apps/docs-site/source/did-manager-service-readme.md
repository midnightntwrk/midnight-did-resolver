> [!NOTE]
> This page is generated from `apps/did-manager-service/README.md` in the repository.
...
- Dev: `pnpm --filter @midnight-ntwrk/midnight-did-manager-service dev`
- Build: `pnpm --filter @midnight-ntwrk/midnight-did-manager-service build`
- Start: `pnpm --filter @midnight-ntwrk/midnight-did-manager-service start`
- Test: `pnpm --filter @midnight-ntwrk/midnight-did-manager-service test`
- Playwright: `pnpm --filter @midnight-ntwrk/midnight-did-manager-service test:e2e`
- Playwright standalone: `pnpm --filter @midnight-ntwrk/midnight-did-manager-service test:e2e:standalone`
- Playwright preprod funding: `pnpm --filter @midnight-ntwrk/midnight-did-manager-service test:e2e:preprod`
