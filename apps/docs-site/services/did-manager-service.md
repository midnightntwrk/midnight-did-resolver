...
- `apps/did-manager-service/src/index.ts`
- `apps/did-manager-service/src/app.ts`
- `apps/did-manager-service/src/manager.ts`
- `apps/did-manager-service/src/manager/`
- `apps/did-manager-service/src/http/`
- `apps/did-manager-service/src/ui/`
- `apps/did-manager-service/README.md`
