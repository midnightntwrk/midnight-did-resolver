...
|---|---|---|
| `did-resolver-service` | REST API and UI for DID resolution | `apps/did-resolver-service/README.md` |
| `did-manager-service` | Wallet setup and DID lifecycle management UI/backend | `apps/did-manager-service/README.md` |
