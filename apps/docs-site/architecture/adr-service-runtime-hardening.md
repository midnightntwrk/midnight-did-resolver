...
```bash
pnpm --filter @midnight-ntwrk/midnight-did-manager-service test -- src/test/config.test.ts src/test/signature-service.test.ts src/test/app.test.ts
pnpm --filter @midnight-ntwrk/midnight-did-resolver-service test -- src/test/indexer-endpoint-policy.test.ts src/test/resolution-errors.test.ts src/test/service.test.ts src/test/app.test.ts
