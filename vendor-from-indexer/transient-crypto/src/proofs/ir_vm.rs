...
use super::{ProofPreimage, ProvingError};
use crate::curve::EmbeddedGroupAffine;
use crate::curve::{FR_BITS, FR_BYTES_STORED, Fr};
use crate::curve::{embedded, outer};
use crate::fab::{AlignmentExt, ValueReprAlignedValue};
use crate::hash::{hash_to_curve, transient_commit, transient_hash};
