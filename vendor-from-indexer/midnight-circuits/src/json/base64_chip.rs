...
mod tests {
    ...
    impl<F: PrimeField> TestCircuit<F> {
        fn new(input: &[u8], output: &[u8], input_pad: bool) -> Self {
    ...
    impl<F: PrimeField> Circuit<F> for TestCircuit<F> {
        ...
        fn synthesize(
            ...
            let ret = b64_chip.from_base64(&mut layouter, &assigned_in, self.input_pad)?;
...
Deep roots are not reached by the frost.
 - J.R.R. Tolkien, 1954";
        ...
        let circuit = TestCircuit::<Fp>::new(b64_input, output, true);
    ...
    fn test_b64chip_truncated() {
        ...
        let circuit = TestCircuit::<Fp>::new(b64_input, output, false);
