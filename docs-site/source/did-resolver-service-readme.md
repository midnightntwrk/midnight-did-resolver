> [!NOTE]
> This page is generated from `did-resolver-service/README.md` in the repository.
...
- Build: `npm run build -w @midnight-ntwrk/midnight-did-resolver-service`
- Dev: `npm run dev -w @midnight-ntwrk/midnight-did-resolver-service`
- Start: `npm run start -w @midnight-ntwrk/midnight-did-resolver-service`
- Unit tests: `npm run test -w @midnight-ntwrk/midnight-did-resolver-service`
- Integration tests: `npm run test:integration -w @midnight-ntwrk/midnight-did-resolver-service`
