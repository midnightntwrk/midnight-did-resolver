  ...
  describe('Verification Methods', () => {
    describe('Multiple Verification Methods with Different Key Types', () => {
      test.skip('should serialize all supported key types', async () => {
        ...
        expect(jubjubKey.publicKeyJwk.x).toBe("3045022100f8c1e4a2d3b5c6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9");
        expect(jubjubKey.publicKeyJwk.y).toBe("00ab5910f4832a6b9c8d7e6f5a4b3c2d1e0f9a8b7c6d5e4f3a2b1c0d9e8f7a6b");
      });
    });
  });
}
